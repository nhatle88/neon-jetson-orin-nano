...
THRESHOLD = 0.45  # Face distance threshold for recognition
...
def main():
    ...
    rtsp_streams = {
        ...
        "Blue wall": "rtsp://admin:@dm1ncamera@luxypq3.duckdns.org:557/Streaming/channels/802"
    }
    ...
    camera_rois = {
        "Labs": (50,30,400,300),
        "Spaceship": (10,100,200,200),
        "Blue Wall": None  # No ROI defined for Camera 3.
    }
